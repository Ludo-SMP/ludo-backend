...
public class RecruitmentStackService {
	...
	public List<RecruitmentStack> createMany(final Recruitment recruitment, final List<Long> stackIds) {
	...
	public void update(final Recruitment recruitment, final List<Long> stackIds) {
		// TODO
	}
