...
public class BasicAuthController {
    ...
    public BasicSignupResponse signup(@RequestBody final BasicSignupRequest request, final HttpServletRequest servletRequest, final HttpServletResponse response) {
        ...
        userDetailsService.createUserDetails(user, servletRequest);
    ...
    public BasicLoginResponse login(@RequestBody final BasicLoginRequest request, HttpServletRequest servletRequest, final HttpServletResponse response) {
