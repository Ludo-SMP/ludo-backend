...
class StudyTest {
    ...
    class AcceptApplicantTest {
        ...
        void notStudyOwner() {
            ...
            // when then
            assertThatThrownBy(() -> study.acceptApplicant(notOwner, applicant, utcDateTimePicker.now()))
        ...
        void notEnoughParticipantRemainCount() {
            ...
            // when then
            assertThatThrownBy(() -> study.acceptApplicant(owner, applicantUser, utcDateTimePicker.now()))
        ...
        void equalsOwnerAndApplicantUser() {
            ...
            // when then
            assertThatThrownBy(() -> study.acceptApplicant(owner, owner, utcDateTimePicker.now()))
        ...
        void success() {
            ...
            // then
            assertThatCode(() -> study.acceptApplicant(owner, applicantUser, utcDateTimePicker.now()))
        ...
        void recruitedWhenParticipantCountEqualsLimit() {
            ...
            while (curParticipantCount-- > 0) {
                ...
                recruitment.addApplicant(applicant);
                study.acceptApplicant(owner, user, utcDateTimePicker.now());
            }
